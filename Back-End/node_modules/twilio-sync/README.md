...
```
<script type="text/javascript" src="//media.twiliocdn.com/sdk/js/sync/v0.9/twilio-sync.min.js"></script>
```
...
For more code examples for Documents and other Sync objects, refer to the [SDK API Docs](https://media.twiliocdn.com/sdk/js/sync/v0.9/docs):
* [Documents](https://media.twiliocdn.com/sdk/js/sync/v0.9/docs/Document.html)
* [Lists](https://media.twiliocdn.com/sdk/js/sync/v0.9/docs/List.html)
* [Maps](https://media.twiliocdn.com/sdk/js/sync/v0.9/docs/Map.html)
* [Message Streams](https://media.twiliocdn.com/sdk/js/sync/v0.9/docs/Stream.html)
* [Live Query](https://media.twiliocdn.com/sdk/js/sync/v0.9/docs/LiveQuery.html)
* [Instant Query](https://media.twiliocdn.com/sdk/js/sync/v0.9/docs/InstantQuery.html)
