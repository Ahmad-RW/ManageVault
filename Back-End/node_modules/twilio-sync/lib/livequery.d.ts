...
export declare class LiveQueryProxy extends SyncEntity {
    private readonly descriptor;
    private attachedLiveQueries;
    constructor(descriptor: LiveQueryDescriptor, services: InsightsServices, removalHandler: RemovalHandler);
    readonly sid: string;
    ...
    attach(liveQuery: LiveQuery): void;
    detach(listenerUuid: string): void;
}
export declare function parseQueryExpression(newQuery: string): string;
 ...
 */
export declare class LiveQuery extends EventEmitter {
    private readonly proxy;
    private readonly uuid;
    private items;
    static readonly type: string;
    readonly type: string;
    readonly listenerUuid: string;
    readonly sid: string;
    /**
     * @private
     */
    constructor(proxy: LiveQueryProxy, items?: any);
    /**
