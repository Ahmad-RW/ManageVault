...
class Client extends events_1.EventEmitter {
    ...
    async liveQuery(indexName, queryExpression) {
        ...
        let queryUri = new utils_1.UriBuilder(this.services.config.insightsUri)
            .pathSegment(indexName)
            .pathSegment('Items')
            .build();
        let jsonQuery = livequery_2.parseQueryExpression(queryExpression);
        ...
        let proxy = this.getCached(response.query_id, livequery_1.LiveQuery.type);
        if (!proxy) {
        ...
        let liveQuery = new livequery_1.LiveQuery(proxy, response.items);
