...
class Client extends events_1.EventEmitter {
    ...
    updateToken(token) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.services.twilsockClient.updateToken(token)
    ...
    setPushRegistrationId(channelType, registrationId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.subscribeToPushNotifications(channelType)
                .then(() => {
    ...
    unsetPushRegistrationId(channelType) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.unsubscribeFromPushNotifications(channelType);
        });
    }
